...
const AiAssistant = (() => {
  ...
  function generateSmartOfflineResponse(text, config) {
    ...
    if (t.includes('نكتة') || t.includes('ضحكني') || t.includes('مزحة')) {
      const jokes = [
        'مرة مبرمج راح ينام.. حط جنبه كاستين مي: وحدة مليانة عشان لو عطش، ووحدة فاضية عشان لو ما عطش! 😂',
        'مرة كمبيوتر عَصّب على الشاشة قالها: فكّي عني شوي بيكفي ضغط! 💻🤣',
        'واحد سأل الذكاء الاصطناعي: تقدر تطبخ؟ قاله: لا بس أقدر أحرق لك الشاشة! 🔥😂'
      ];
      return jokes[Math.floor(Math.random() * jokes.length)];
    }

    return `سؤال رائع! ⚡\nأنا هنا لمساعدتك في كل ما يخص **منصة زلزال**. يمكنك اختيار أحد الأسئلة المقترحة في الأسفل أو سؤالي عن الألعاب وروابط المجتمع والتحديثات! 👑`;
  }
